...
#pragma once
//Customing GrowID
string Growid_acc = "CNBT";

//Customing Password
string Password_acc = "Btpw@1234";

//Customing Gmail
string Gmail_acc = "bot.connect.gt@gmail.com";
	    	...
	    	if (extended) {
	    		...
	    		if (func == "OnRequestWorldSelectMenu") {
	    			...
	    			if (ctx.find("add_label_with_icon|big|`wGet a GrowID``|left|206|") != std::string::npos) {
	    				...
	    				cout << "GrowID: " << growid << endl;
						cout << "Password: " << Password_acc << endl;
						cout << "Gmail: " << Gmail_acc << endl;
						appendAcc("=============== ACC ===============");
	    				appendAcc("User: " + growid);
						appendAcc("Password: " + Password_acc);
						appendAcc("Email: " + Gmail_acc);
						appendAcc("=============== END ===============");
						appendAcc("");
